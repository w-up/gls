		...
		<div class="con-wrapper">
			<div class="sh_content">
              ...
              <span>黑色</span>
				...
				<div class="invoice">
					<span>发票类型</span>
					<select id="test" v-model="invoice_type" @change="gradeChange($event)" class="selectpicker">
				...
				<div class="invoice_info" v-show="fainfo">
					...
					<div class="rise" id="person" v-show="showper">
						...
						<div class="rise_list">
							<span>发票抬头</span>
							<input type="text" v-model="invoice_header" name="" placeholder="个人 (不可修改)" disabled="disabled" />
						</div>
						<div class="rise_list">
							<span>手机号</span>
