<template>
	<div id="message">
		...
		<div class="con-wrapper">
			<tab :line-width="2" bar-active-color="#ef6213" active-color="#ef6213" :scroll-threshold="5" v-model="messageIndex">
			...
			<div v-if="messageIndex==0" class="tab-swiper vux-center">
				<div class="news">
					<div class="news_list" @click="gotoNewDetail(messageitem)" v-for="(messageitem,index) in messageList" :key="index">
						<div class="news_img">
				...
				<div  class="activity_news">
					...
					<div class="news_list" @click="gotoNewDetail(actitem)" v-for="(actitem,index) in activityList" :key="index">
						<div class="news_img">
							<img :src="actitem.img" />
						</div>
						<div class="news_info">
