	...
	<div id="alipay">
		...
		<div class="con-wrapper">
			<div class="rech_con">
				...
				<div class="rech_list">
					<span>支付宝号：</span>
					<input v-if="useMsg.alipay !== ''" type="text" v-model="useMsg.alipay" name="" disabled="disabled" />
					<input v-if="useMsg.alipay == ''" type="text" v-model="alipay" name="" placeholder="请输入您的支付宝号" />
				</div>
