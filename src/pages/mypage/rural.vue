  ...
  <div id="orchard">
    ...
    <div class="con-wrapper">
      <div class="detail_con">
        <div class="detail_list" v-for="(item,index) in ruralList" :key="index">
      ...
      <div id="no-data" v-if="ruralList.length == 0">
