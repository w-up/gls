!function(e, t) {
  ...
  return function(e) {
      ...
      function a(e, t) {
          ...
          d.IS_X5TBS && e.x5_player ? b.mobile = ["flv", "m3u8", "mp4"] : d.IS_ENABLED_MSE && e.h5_flv && (b.mobile = ["flv", "m3u8", "mp4"])) : (e.flash = !!t.isFormat("rtmp") || e.flash,
          t.isFormat("flv") && void 0 == e.flash && (e.flash = !0),
          e.flash ? d.IS_ENABLED_FLASH || (e.flash = !1,
          d.IS_ENABLED_MSE ? e.h5_flv && (d.IS_SAFARI && A.compareVersion(d.SAFARI_VERSION, "10.1") > -1 || !d.IS_SAFARI) ? b.pc = ["flv", "m3u8", "mp4"] : b.pc = ["m3u8", "mp4"] : b.pc = ["mp4"]) : d.IS_ENABLED_MSE ? e.h5_flv && (d.IS_SAFARI && A.compareVersion(d.SAFARI_VERSION, "10.1") > -1 || !d.IS_SAFARI) ? b.pc = ["flv", "m3u8", "mp4"] : b.pc = ["m3u8", "mp4"] : d.IS_ENABLED_FLASH ? e.flash = !0 : b.pc = ["mp4"]),
          e.clarity) {
  ...
  , function(e, t) {
      ...
      t.IS_ANDROID = /Android/i.test(i))
        ...
        , p = (t.IS_OLD_ANDROID = c && /webkit/i.test(i) && u < 2.3,
      t.IS_NATIVE_ANDROID = c && u < 5 && n < 537,
      t.IS_FIREFOX = /Firefox/i.test(i),
      t.IS_EDGE = /Edge/i.test(i))
      ...
      t.IS_MQQB = !y && /MQQBrowser\/\d+/i.test(i),
      t.IS_MOBILE = c || l,
          ...
          if (document.all || f)
              try {
                  if (e = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"))
                      return t.FLASH_VERSION = A = e.GetVariable("$version").split(" ")[1].replace(/,/g, "."),
                      window.console && console.log("FLASH_VERSION", A),
                      !0
              } catch (i) {
                  return !1
              }
              ...
              try {
                  if (navigator.plugins && navigator.plugins.length > 0 && (e = navigator.plugins["Shockwave Flash"])) {
                      for (var o = e.description.split(" "), n = 0; n < o.length; ++n)
                          isNaN(parseInt(o[n])) || (t.FLASH_VERSION = A = o[n],
                          window.console && console.log("FLASH_VERSION", parseInt(o[n])));
                      return !0
                  }
              } catch (i) {
                  return !1
  ...
  , function(e, t, i) {
      ...
      function l(e) {
          ...
          p.__isFullscreen || g.off(document, S.fullscreenchange, l),
          b.pub({
      ...
      function c(e, t) {
          g.off(t.video.el, "webkitbeginfullscreen", c),
          "webkitbeginfullscreen" == e.type ? (g.on(t.video.el, "webkitendfullscreen", function(e) {
              c(e, t)
          }),
          b.pub({
              type: w.MSG.FullScreen,
          ...
          }, p.player)) : "webkitendfullscreen" == e.type && (g.off(t.video.el, "webkitendfullscreen", c),
          b.pub({
              type: w.MSG.FullScreen,
              src: "util",
              ts: e.timeStamp,
      ...
      function p(e, t, i) {
          ...
          p.player = e,
          S.requestFullscreen ? t ? (g.on(document, S.fullscreenchange, l),
          i && i[S.requestFullscreen]()) : document[S.exitFullscreen]() : o && e.video.el.webkitEnterFullScreen ? (g.on(e.video.el, "webkitbeginfullscreen", function(t) {
              c(t, e)
          }),
          t ? e.video.el.webkitEnterFullScreen() : e.video.el.webkitExitFullscreen()) : (p.__isFullscreen = t,
          p.__isFullscreen ? (p.__origOverflow = document.documentElement.style.overflow,
          document.documentElement.style.overflow = "hidden",
          g.on(document, "keydown", u)) : (document.documentElement.style.overflow = p.__origOverflow,
          g.off(document, "keydown", u)),
          g.toggleClass(document.body, "vcp-full-window", t),
          b.pub({
              type: w.MSG.FullScreen,
              src: "util",
              detail: {
      ...
      t.getFormat = A,
      t.unifyProtocol = v;
      for (var m = i(2), g = o(m), w = i(4), b = o(w), M = i(1), I = (o(M),
      1), S = t.FullscreenApi = {
          ...
          E[D][1]in document && (T = E[D]);
      if (T)
          for (var L = 0; L < T.length; L++)
              S[_[L]] = T[L];
      t.CDNPath = "https://imgcache.qq.com/open/qcloud/video/vcplayer/",
      t.VideoType = {
          RTMP: "rtmp",
          FLV: "flv",
          M3U8: "m3u8"
  ...
  , function(e, t, i) {
      ...
      t.Player = function() {
          ...
          return e.prototype.render = function(e) {
              ...
              (C.IS_SAFARI && parseInt(C.SAFARI_VERSION) > 10 || C.IOS_VERSION > 10) && "system" == this.options.controls || (this.bigplay = new b["default"](this),
          ...
          e.prototype.setup = function() {
              if (this.__handleEvent = x.bind(this, this.handleEvent),
              C.IS_MOBILE) {
          ...
          e.prototype.handleMsg = function(e) {
              ...
              case O.Play:
                  ...
                  this.video.type() == x.VideoType.RTMP && (this.__wait = !0,
                  this.loading.show()),
        ...
        , w = function(e) {
          ...
          t.prototype.interval = function() {
              ...
              if (this.__m3u8) {
                  ...
                  this.__buffered !== i && (this.__buffered = i,
                  this.pub({
                      type: p.MSG.Progress,
                      src: this,
                      ts: +new Date
          ...
          ,
          t.prototype.togglePlay = function() {
              this.metaDataLoaded ? this.playState == v.PlayStates.PAUSED ? this.el.playerResume() : this.playState == v.PlayStates.PLAYING ? this.el.playerPause() : this.playState == v.PlayStates.STOP ? (this.currentTime(0),
